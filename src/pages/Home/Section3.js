      ...
      <Container>
        <Row>
          <Col lg={{ span: 8, offset: 2 }} className='text-center mb-5'>
            ...
            <p className='para'>Porta semper lacus cursus, feugiat primis ultrice a ligula risus auctor an tempus
              feugiat dolor lacinia cubilia curae integer orci congue and metus integer primis in integer metus
            </p>
          </Col>
        </Row>
        <Row>
        ...
        <Row className='pt-5'>
          <Col sm={6} lg={5}>
            <div className='ads_box ads_img1 mb-5 mb-md-0'>
              ...
              <h5>CHEESE FRIES</h5>
              <Link to="/menu" className='btn btn_red px-4 rounded-0'>Learn More</Link>
            </div>
          </Col>
          <Col sm={6} lg={7}>
